<div class="row">
	<div class="col-md-8">
		<div class="form-group">
			...
			<div class="col-md-10">
				<input type="text" class="form-control" name="title" autofocus id="title" value="<?php echo e($title); ?>">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-10">
				<div class="row">
					<div class="col-md-8">
						<input type="text" class="form-control" name="page_image" id="page_image" onchange="handle_image_change()" alt="Image thumbnail" value="<?php echo e($page_image); ?>">
					</div>
					<script>
						function handle_image_change() {
							$("#page-image-preview").attr("src", function () {
								...
								if (value.substr(0, 4) != 'http' && value.substr(0, 1) != '/') {
									value = <?php echo json_encode(config('blog.uploads.webpath')); ?> + '/' + value;
								}
								return value;
							});
						}
					...
					<div class="col-md-4 text-right">
						 <img src="<?php echo e(page_image($page_image)); ?>" class="img img_responsive" id="page-image-preview" style="max-height:40px">
					</div>
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-10">
				 <textarea class="form-control" name="content" rows="14" id="content"><?php echo e($content); ?></textarea>
			</div>
		</div>
	</div>
	<div class="col-md-4">
		<div class="form-group">
			...
			<div class="col-md-8">
				<input class="form-control" name="publish_date" id="publish_date" type="text" value="<?php echo e($publish_date); ?>">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-8">
				<input class="form-control" name="publish_time" id="publish_time" type="text" value="<?php echo e($publish_time); ?>">
			</div>
		</div>
		<div class="form-group">
			<div class="col-md-8 col-md-offset-3">
				<div class="checkbox">
					<label>
						<input <?php echo e(checked($is_draft)); ?> type="checkbox" name="is_draft">
						Draft?
					</label>
				 </div>
			</div>
