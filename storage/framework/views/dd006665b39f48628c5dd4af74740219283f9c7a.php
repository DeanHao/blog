		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('admin.post.update', $id)); ?>">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<form method="POST" action="<?php echo e(route('admin.post.destroy', $id)); ?>">
						<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
